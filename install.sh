...
sudo apt update
sudo apt install -y autoconf automake cmake code gdal-bin git libsqlite3-dev libtool raspberrypi-kernel-headers nginx nodejs osmium-tool parallel python-gdal ruby sqlite3 tmux vim xrdp yarn zip 
