...
sudo apt update
sudo apt install -y autoconf automake cmake gdal-bin git libsqlite3-dev libtool raspberrypi-kernel-headers nginx nodejs osmium-tool ruby sqlite3 tmux vim xrdp yarn zip 
